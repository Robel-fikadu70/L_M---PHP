...
<body class="custom">
    <section class="app" style="width: 100%; height: 300px">
        <!-- <img src="Assets/img/33%20Creative%20Bookshelf%20Designs.jpg" class="img-fluid" style="width: 100%; height: 300px; object-fit: cover;" /> -->
        <div class="container">
            <div class="row">
    ...
    <section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <center>
                        ...
                        <p><b>Our 3 main primary features</b></p>
                    </center>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <center>
                        <img style="width: 150px;" src="Assets/img/research.png" />
                ...
                <div class="col-md-4">
                    <center>
                        <img style="width: 150px;" src="Assets/img/time-to-study.png" />
                ...
                <div class="col-md-4">
                    <center>
                        <img width="150px" src="Assets/img/monitoring.png" />
            ...
            <div class="row">
                <div class="col-md-4">
                    <center>
                        ...
                        <img style="width: 150px;" src="Assets/img/signup.png" />
                ...
                <div class="col-md-4">
                    <center>
                        <img style="width: 150px;" src="Assets/img/verified-account.png" />
                ...
                <div class="col-md-4">
                    <center>
                        <img width="150" src="Assets/img/reading-book.png" />
